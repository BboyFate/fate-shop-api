    ...
    public function run()
    {
        $productData = [
            [
                ...
                "price"       => "399.00",
                "skus"        => [
                    ["name" => "8GB 黑色", "description" => "8GB 2400 DDR4 黑色", "price" => "549.00"],
                    ["name" => "8GB 绿色", "description" => "8GB 2400 DDR4 绿色", "price" => "529.00"],
                    ["name" => "16GB", "description" => "2400 16GB", "price" => "1299.00"],
                    ["name" => "4GB", "description" => "2400 4GB", "price" => "399.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "金士顿"],
                    ["name" => "内存容量", "value" => "8GB"],
            ...
            [
                ...
                "price"       => "489.00",
                "skus"        => [
                    ["name" => "8GB DDR4 2400", "description" => "8GB DDR4 2400 XPG单条", "price" => "489.00"],
                    ["name" => "4GB 万紫千红 DDR4 2133", "description" => "4GB 万紫千红 DDR4 2133", "price" => "489.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "威刚"],
                    ["name" => "传输类型", "value" => "DDR4"],
            ...
            [
                ...
                "price"       => "239.00",
                "skus"        => [
                    ["name" => "DDR3 1600 8G", "description" => "DDR3 1600 8G", "price" => "439.00"],
                    ["name" => "DDR3 1600 4G", "description" => "DDR3 1600 4G", "price" => "239.00"],
                    ["name" => "DDR3 1333 4G", "description" => "DDR3 1333 4G", "price" => "259.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "金士顿"],
            ...
            [
                ...
                "price"       => "489.00",
                "skus"        => [
                    ["name" => "16GB 3000", "description" => "16GB 3000 8GB*2", "price" => "1199.00"],
                    ["name" => "16GB 3600", "description" => "16GB 3600 8GB*2", "price" => "1379.00"],
                    ["name" => "8GB 2400", "description" => "8GB 2400 DDR4", "price" => "489.00"],
                    ["name" => "8GB 3000", "description" => "8GB 3000 DDR4", "price" => "519.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "影驰"],
                    ["name" => "传输类型", "value" => "DDR4"],
            ...
            [
                ...
                "price"       => "359.00",
                "skus"        => [
                    ["name" => "DDR4 8G 2400", "description" => "DDR4 8G 2400", "price" => "519.00"],
                    ["name" => "DDR4 4G 2400", "description" => "DDR4 4G 2400", "price" => "359.00"],
                    ["name" => "DDR4 8G*2 2400", "description" => "DDR4 8G*2 2400", "price" => "1279.00"],
                    ["name" => "DDR4 16G 2400", "description" => "DDR4 16G 2400", "price" => "1279.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "海盗船"],
                    ["name" => "内存容量", "value" => "16GB"],
            ...
            [
                ...
                "price"       => "539.00",
                "skus"        => [
                    ["name" => "DDR4 2400 8G", "description" => "DDR4 2400 8G", "price" => "539.00"],
                    ["name" => "DDR4 2133 8G", "description" => "DDR4 2133 8G", "price" => "539.00"],
                    ["name" => "DDR4 2666 8G", "description" => "DDR4 2666 8G", "price" => "589.00"],
                    ["name" => "DDR4 2400 16G", "description" => "DDR4 2400 16G", "price" => "1199.00"],
                ],
                "properties"  => [
                    ["name" => "品牌名称", "value" => "三星"],
                    ["name" => "传输类型", "value" => "DDR4"],
        ...
        // 查找名为『内存』的商品类目
        $category = ProductCategory::where('name', '内存')->first();
